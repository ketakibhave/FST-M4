--Load data from HDFS
inputDialogs = LOAD 'hdfs:///user/root/inputs/episodeV_dialouges.txt' USING PigStorage '\t' AS (name:chararray, line:chararray);
...
STORE namesOrdered INTO 'hdfs:///user/root/outputs/results_episodeV';
