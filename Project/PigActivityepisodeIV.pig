--Load data from HDFS
inputDialogs = LOAD 'hdfs:///user/root/inputs/episodeIV_dialouges.txt' USING PigStorage '\t' AS (name:chararray, line:chararray);
...
STORE namesOrdered INTO 'hdfs:///user/root/outputs/results_episodeIV';
